...
print("""streamr-feed.py - modified from luftdaten.py in enviroplus examples 
Reads temperature, pressure, humidity,
PM2.5, and PM10 from Enviro plus and sends data to an http endpoint
...
def read_values():
    ...
    try:
        ...
        values["P2"] = "-1"    # No PM sensor on Enviro
        values["P1"] = "-1"
    return values
...
while True:
    try:
        ...
        values = read_values()
        print(values)
        if time_since_update > 3:       # seconds between sends
